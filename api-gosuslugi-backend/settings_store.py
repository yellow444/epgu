...
ALLOWED_KEYS = {
    ...
    # Автоматическая обработка почты. Забор вложений безопасен, а отправка
    # подтверждений уходит наружу от имени организации, поэтому это отдельные
    # выключатели с отдельными значениями по умолчанию.
    "MAIL_AUTO_ENABLED",
    "MAIL_AUTO_COLLECT",
    "MAIL_AUTO_CONFIRM",
    "MAIL_AUTO_CONFIRM_AFTER",
